...
<div class="container text-center wrapper fadeInDown" style="margin-top: 100px;" id="formContent">
		  ...
		  <form:form action="/updateDue/${bill.id}" method="post" commandName="billeditForm" modelAttribute="billeditForm">
			<div class="m-3">
			<h1>User Bill Payment</h1>
				...
				<div class="form-group row">
					...
					<div class="col-8">
						<form:input class="form-control" path="elecBill"  value="${bill.elecBill}" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-8">
					<form:input class="form-control" path="mainBill" value="${bill.mainBill}" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-8">
						<form:input class="form-control" path="watBill"  value="${bill.watBill}" />
					</div>
				</div>
				<div class="form-group row">
					<label class="col-4 col-form-label">Status </label>
					<div class="col-8">
						<form:input class="form-control" path="elecStat"  value="${bill.elecStat}" />
					</div>
				</div>
				<div class="form-group row">
					<label class="col-4 col-form-label">Status </label>
					<div class="col-8">
						<form:input class="form-control" path="mainStat"  value="${bill.mainStat}" />
					</div>
				</div>
				<div class="form-group row">
					<label class="col-4 col-form-label">Status </label>
					<div class="col-8">
						<form:input class="form-control" path="watStat"  value="${bill.watStat}" />
					</div>
				</div>
