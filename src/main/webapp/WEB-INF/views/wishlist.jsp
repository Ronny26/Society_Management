   ...
   <div class="col-md-3 col-sm-6">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p style="color:green;"><b>Rs.${property.price}</b> <i class="material-icons text-danger" >new_releases</i></p>
            <p>${property.description} </p>
             <span> <a href="/view-details?id=${property.id}" >View Details</a></span><span> <a class="btn btn-danger fav text-white" href="/delete-from-wishlist?id=${property.id}">Remove from WishList</a></span>
        </div>
    </div>
</div>
</c:forEach>
